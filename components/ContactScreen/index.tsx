  ...
  return (
    ...
    >
      ...
      <div className='relative flex flex-col items-center'>
        ...
        <h3 className='top-24 absolute uppercase tracking-[10px] md:tracking-[20px] text-gray-500 text-1xl md:text-2xl text-center'>Contact</h3>
      ...
      <div className='flex flex-col space-y-5 mt-[14rem]'>
        ...
        <div className='space-y-1'>
          <div className='flex items-center space-x-5 justify-center'>
            <PhoneIcon className='text-[#F7AB0A]/50 h-6 w-6 animate-pulse' />
            <p className='text-[13px] md:text-[15px]'>+2348102718467</p>
          </div>

          <div className='flex items-center space-x-5 justify-center'>
            <EnvelopeIcon className='text-[#F7AB0A]/50 h-6 w-6 animate-pulse' />
            <p className='text-[10px] md:text-[12px]'>oyahebholokennethizosea@gmail.com</p>
          </div>

          <div className='flex items-center space-x-5 justify-center'>
            <MapPinIcon className='text-[#F7AB0A]/50 h-6 w-6 animate-pulse' />
            <p className='text-[10px] md:text-[12px]'>Agbowo, Akinfala Street, Ibadan.</p>
          </div>
